describe('Login Page +', function () {
    ...
    it('Visual check', function () {
        ...
        cy.get('label#message23')
            .should('not.be.visible')
        cy.get('label#message18')
            .should('not.be.visible')
        cy.get('h2')
            .should('be.visible').and('have.text', 'Guru99 Bank')
    });
    ...
    it('Checking Valid Inputs', function () {
        ...
        cy.url()
            .should('eq','https://demo.guru99.com/Agile_Project/Agi_V1/customer/Customerhomepage.php')
        cy.get('.heading3')
            .should('be.visible').and('have.text', "Welcome To Customer's Page of Guru99 Bank")
    });
...
describe.skip('Login Page -', function () {
    ...
    it('Checking empty fields', function () {
        ...
        cy.get('label#message23')
            .should('be.visible').and('have.text', 'User-ID must not be blank')
        cy.get('label#message18')
            .should('be.visible').and('have.text', 'Password must not be blank')
    ...
    it('Only password field filled', function () {
        ...
        cy.get('input[type="submit"]').click()
        cy.url()
            .should('eq', 'https://demo.guru99.com/Agile_Project/Agi_V1/index.php')
        cy.get('label#message23')
            .should('be.visible').and('have.text', 'User-ID must not be blank')
    });
